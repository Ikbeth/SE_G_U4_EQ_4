...
INSERT [dbo].[device_manager] ([id_device], [device_name], [current_value], [owner_name], [max_value], [min_value], [setpoint]) VALUES (CAST(1 AS Numeric(18, 0)), N'Potenciometro', CAST(150 AS Numeric(18, 0)), NULL, NULL, NULL, NULL)
INSERT [dbo].[device_manager] ([id_device], [device_name], [current_value], [owner_name], [max_value], [min_value], [setpoint]) VALUES (CAST(2 AS Numeric(18, 0)), N'Ultrasonido', CAST(120 AS Numeric(18, 0)), NULL, NULL, NULL, NULL)
INSERT [dbo].[device_manager] ([id_device], [device_name], [current_value], [owner_name], [max_value], [min_value], [setpoint]) VALUES (CAST(3 AS Numeric(18, 0)), N'Fotoeléctrico', CAST(150 AS Numeric(18, 0)), NULL, NULL, NULL, NULL)
INSERT [dbo].[device_manager] ([id_device], [device_name], [current_value], [owner_name], [max_value], [min_value], [setpoint]) VALUES (CAST(4 AS Numeric(18, 0)), N'Fotoresistencia', CAST(120 AS Numeric(18, 0)), NULL, NULL, NULL, NULL)
INSERT [dbo].[device_manager] ([id_device], [device_name], [current_value], [owner_name], [max_value], [min_value], [setpoint]) VALUES (CAST(5 AS Numeric(18, 0)), N'Micrófono', CAST(150 AS Numeric(18, 0)), NULL, NULL, NULL, NULL)
